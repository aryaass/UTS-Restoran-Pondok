		...
		<div class="parallax_content">
			<div class="detail_holder">
				<div class="detail_img">
					<img src="image/FoodPics/<?php echo $id;?>.jpg" alt="no image found" />
				</div>
				<div class="detail_desc">
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc price">Price:</span> Rp<span id="price"><?php echo $price; ?></span></p>
						...
						<p><span class="bold_desc">Total Price:</span> Rp<span id="total_price"><?php echo $price; ?></span></p>
						<div class="form_group">
