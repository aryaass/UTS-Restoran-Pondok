		...
		if($cat->num_rows) {
			...
			while($row = $cat->fetch_assoc()) {
				...
				$result .=  "<tr>
								...
								<td>$foodPrice</td>
								<td>$foodCat</td>
								<td><a href='index.php?delete=".$id."' onclick='return check();'><i class='pe-7s-close-circle'></i></a></td>
							</tr>";
...
<head>
	...
	<title>Restoran Pondok | Admin</title>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='index.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #FF5722;' >$i</a>  "  : " <a href='index.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
