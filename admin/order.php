<?php 
	...
	$status = 'Session Time Expired';
	$logged = 'login';

	if(isset($_COOKIE['isLoged'])) {
		$admin = getUserById($_COOKIE['isLoged']);
		$status = "Welcome Admin " . $admin['username'];
		$logged = 'logout';
		echo '<script>console.log("Cookies Saved")</script>';
	}
...
<head>
	...
	<title>Restoran Pondok | Riwayat Pemesanan</title>
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;"><?= $status; ?></a>
                </div>
                <div class="collapse navbar-collapse">

                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?=$logged?>.php" style="color: #fff;">
                                <?=$logged?>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="card">
							...
							<div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='order.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #FF5722;' >$i</a>  "  : " <a href='order.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
                            </div>
                        </div>
